...
package com.cw.lightblue.service;
...
public class BluetoothLeService extends Service {
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status) {
            if (status == BluetoothGatt.GATT_SUCCESS) {
                ...
                Log.w(TAG, "onConnectionStateChange: " + "onServicesDiscovered received: " + status);
            }
        }
        ...
        public void onCharacteristicWrite(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status) {
            Log.i(TAG, "onCharacteristicWrite: " + "--------write success----- status:" + status);
        }
    };
    ...
    private void broadcastUpdate(final String action, final BluetoothGattCharacteristic characteristic) {
        ...
        if (UUID_HEART_RATE_MEASUREMENT.equals(characteristic.getUuid())) {
            ...
            if (data != null && data.length > 0) {
                ...
                Log.i(TAG, "broadcastUpdate: " + "ppp" + new String(data) + "\n" + stringBuilder.toString());
    ...
    public void setCharacteristicNotification(
        ...
        if (descriptor != null) {
            Log.i(TAG, "setCharacteristicNotification: write descriptor");
